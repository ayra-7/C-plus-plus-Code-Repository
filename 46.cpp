...
// Abstract base class -> meant to form derived classes and can't have obj
class CWH
{
  protected:
  string title;
  float rating;
   ...
   // This function ought to be defined in the derived classes
};
...
class CWHtext: public CWH
{
 ...
 // if not declared then would give error but if it is
 // normal virtual function in base class code will not give error even if not declared
 void display()
 {
